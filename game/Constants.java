...
public class Constants {
  ...
  // set to your path
  public static final String FILENAME = "/Users/kevinchen/Documents/Software Design/Lecture Notes/A1soln/src/game/grid4.txt";
  ...
  // ------- constants for final state of the game ------
  
  /** The integer for vacuum 1 winning. */
  public static final int VACUUM_ONE_WINS = 1;
  
  /** The integer for vacuum 2 winning. */
  public static final int VACUUM_TWO_WINS = 2;
  
  /** The integer for a tie. */
